          ...
          <div className="max-w-content mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-12 items-end">
              <div className="max-w-3xl">
                ...
                />
                <WordReveal
                  text="Clear tradeoffs."
                  as="h1"
                  className="font-serif italic mb-6"
                  style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-0.03em', color: 'var(--amber)' }}
                  delay={0.25}
                />
                <motion.p
                  className="text-white/55 font-sans text-lg leading-relaxed max-w-2xl"
                  initial={{ opacity: 0, y: 16 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.45, ease: [0.22, 1, 0.36, 1] as const }}
                >
                ...
                {PLANS.map((plan, i) => {
                  ...
                  const card = (
                    <SpotlightCard
                      ...
                      spotlightColor={plan.highlighted ? 'rgba(200,135,58,0.18)' : 'rgba(200,135,58,0.13)'}
                    >
                      {/* Recommended badge */}
                      {plan.highlighted && (
                  ...
                  return plan.highlighted ? (
                    <ShimmerBorder key={plan.id} className="relative flex flex-col">
                      {card}
                    </ShimmerBorder>
                  ) : card
                })}
        ...
        <section className="bg-stone py-20 px-6">
          <div className="max-w-content mx-auto">
            <AnimateIn className="mb-12">
              ...
              <WordReveal
                text="Expand capacity without changing plans."
          ...
          <div className="max-w-narrow mx-auto">
            <AnimateIn>
              <WordReveal
                ...
                className="font-serif italic text-ink justify-center text-center mb-12"
                style={{ fontSize: '1.5rem', letterSpacing: '-0.02em' }}
              />
            </AnimateIn>
            <AnimateIn delay={80}>
